...
int input_2()
{
	for(i=1;i<=1;)
	{
	if(row==1 && column ==1 && a11!='x')
	{
		a11='o'; break;
	} else if (row==1 && column ==2&&a12!='x')
	{
		a12='o'; break;
	} else if (row==1 && column ==3&&a13!='x')
	{
		a13='o'; break;
	} else if (row==2 && column ==1&&a21!='x')
	{
		a21='o'; break;
	} else if (row==2 && column ==2&&a22!='x')
	{
		a22='o'; break;
	} else if (row==2 && column ==3&&a23!='x')
	{
		a23='o'; break;
	} else if (row==3 && column ==1&&a31!='x')
	{
		a31='o'; break;
	} else if (row==3 && column ==2&&a32!='x')
	{
		a32='o'; break;
	} else if (row==3 && column ==3&&a33!='x')
	{
		a33='o';
	} else {
		cout <<"no space \n\n";
